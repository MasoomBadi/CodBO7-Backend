-- phpMyAdmin SQL Dump
-- Call of Duty Companion App - Complete Database Schema with Data
...
('icons', 1, 1, CURRENT_TIMESTAMP, 'Icons and emblems'),
('operators', 1, 1, CURRENT_TIMESTAMP, 'Playable characters');
